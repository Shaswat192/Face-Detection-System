...
model = load_model("C:/Users/soume/OneDrive/Attachments/Desktop/Face Detection/Face Detection/final_model.h5")

URL = 'http://192.168.231.197:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["Pratik", "Raj", "Sambit", "Shaswat"]
    return labels[pred]
